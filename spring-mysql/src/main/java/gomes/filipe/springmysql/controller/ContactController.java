package gomes.filipe.springmysql.controller;
...
import gomes.filipe.springmysql.repository.ContactRepository;
...
public class ContactController {
	...
	// A anotação @RequestBody indica que o parâmetro contact deve ser vínculado ao corpo da requisição
	@PostMapping
